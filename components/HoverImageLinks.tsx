    ...
    >
      <div>
        <motion.span
          ...
          className="relative z-10 block text-4xl font-bold text-neutral-500 transition-colors duration-500 group-hover:text-neutral-50 text-xl sm:text-4xl  md:text-6xl"
        >
          {heading.split("").map((l:number, i:number) => (
            <motion.span
              variants={{
                initial: { x: 0 },
                whileHover: { x: 16 },
